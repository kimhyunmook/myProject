            ...
            <form ref={form} action="" style={formStyle} className="">
                ...
                <div ref={settingCover} className="setting_cover" style={coverStyle}>
                    ...
                    <OverlapUi button="확인" onClick={next2}>
                        ...
                        <ul>
                            <InputLi type='text' value={host} onChange={onHostHandler} placeholder={'domain'}>host</InputLi>
                            <InputLi type='text' value={dbUser} onChange={onUserHandler} placeholder={'db_id'}>user</InputLi>
                            <InputLi type='password' value={dbPassword} onChange={onPasswordHandler} placeholder={'db_pw'}>password</InputLi>
                            <InputLi type='text' value={db} onChange={onDbHandler} placeholder={'db_name'}>database</InputLi>
                        </ul>
                    </OverlapUi>
